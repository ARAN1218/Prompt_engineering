...
## 1. 入力操作系攻撃（Input Manipulation Attacks）
...
## 2. データ汚染系リスク（Data Corruption Risks）
...
## 3. システム連携・権限系リスク（System Integration/Privilege Risks）
...
## 4. 情報漏洩・記憶系リスク（Information Disclosure/Memorization Risks）
...
## 5. その他のリスク・設計上の問題（Other/Structural Risks）
